...
class Workflow_Dashboard(IntegrationTestSetup): 
    ...
    def test_create_get_delete_eleve(self):
        ...
        debug_print( teacher_list)
            # [ {'id': 10, 'username': 'teacher1', 'first_name': 'New', 'last_name': 'Teacher', 'roles': ['teacher']}, 
            #   {'id': 11, 'username': 'teachertest1', 'first_name': 'New1', 'last_name': 'Teacher', 'roles': ['teacher']}, 
            #   {'id': 12, 'username': 'teachertest2', 'first_name': 'New2', 'last_name': 'Teacher', 'roles': ['admin', 'teacher']}]
    ...
    def _login_as_user(self, username, password):
        ...
        response = self.api_util._login_user(username, password)
